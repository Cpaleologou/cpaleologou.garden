...
---
Chaos, death, extinction are the only sure things in this cold universe. Nature's solution is not to live forever, but to allow things to change. Allow species to adapt. 

Allow individuals within species to have different skills sets. 

So that one, day when chaos beckons, someone is able to handle it. At least better than the rest. 

If variation in genetics, within species and across species, is the only sure strategy for the continuance of a species or the continuance of life, what else does that mean for the concept? 
