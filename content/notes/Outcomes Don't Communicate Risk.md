---
title: Outcomes Don't Communicate Risk
tags:
  - '#Investing'
  - '#DecisionMaking'
publish: 'true'
...
**Link Explanation:**
Second-level thinking is the tool required to build strong qualitative models that are better predictive of the future than quantitative models. By thinking through the second-order implications of current information was can get a feeling for the possible futures that exist, rather than assuming the future will remain the same as the past.
