---
title: Scaling Is About How A System Responds To Size
tags:
  - '#Scaling'
  - '#Systems'
  - '#Definition'
...
**Link Explanation:**
The linked note discusses how we see predictable scaling laws all over the place - in animals, cities, companies, etc. So while the current note defines the term "scaling", the linked note elaborates to raise a question whether predictable, universal scaling laws exist.
