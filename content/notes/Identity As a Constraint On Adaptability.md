---
title: Identity As a Constraint On Adaptability
tags:
  - '#Identity'
  - '#Acceleration'
publish: 'true'
...
**Link Explanation:**
The note linked provides an intriguing contrast to the note above. While the note above discusses the value of *internal* *fluidity*, the linked note promotes the importance of *external durability* in the world around us in order for our actions to hold meaning.
