---
title: 'You can be right, but look wrong for a long time'
tags:
  - '#Investing'
  - Markets
publish: 'true'
...
---
Being right and seeing the rewards immediately are not the same thing in capital markets. Even a well-reasoned position can go against you for months or even years. An undervalued stock can continue to drop for a long time, before finally recovering to the mean. 
