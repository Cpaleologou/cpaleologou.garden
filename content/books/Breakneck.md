...
<div class="book-header">
  <img src="/assets/Breakneck.webp" alt="Breakneck">
  <div class="book-header-meta">
    <p class="book-genre">Politics | Economics | Technology · 2025</p>
    <p class="book-author">Dan Wang</p>
    <hr>
    <p class="book-title">Breakneck</p>
    <p class="book-subtitle">China's Quest to Engineer the Future</p>
